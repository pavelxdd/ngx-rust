...
use crate::bindings::{
    ...
    ngx_resolver_ctx_t, ngx_str_t, ngx_time_t, ngx_uint_t, ngx_variable_value_t, time_t,
};
...
pub const NGX_ALIGNMENT: usize = bindings::NGX_RS_ALIGNMENT;
...
// requirements.
const _: () = assert!(mem::align_of::<ngx_str_t>() <= NGX_ALIGNMENT);
