...
pub use crate::http::{
    ...
    HttpUpstreamInitializer, HttpUpstreamPeerHandler, HttpVariableCacheInvalidation,
    HttpVariableCacheInvalidationError, HttpVariableFlags, HttpVariableHandler, HttpVariableIndex,
    HttpVariableIndexError, HttpVariableLookupError, HttpVariableOutput, HttpVariableOutputError,
    HttpVariablePoolBytes, HttpVariableRegistrationError, HttpVariableSetter, HttpVariableValueRef,
    IntoHandlerStatus, Merge, MergeConfigError, OriginalPeerFree, OriginalPeerGet, ProcessCycle,
