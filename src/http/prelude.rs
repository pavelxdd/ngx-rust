...
pub use crate::http::{
    ...
    RequestRef, RequestRefMut, RequestTempFile, RequestTempFileError, UpstreamAddress,
    UpstreamAddresses, UpstreamCallbackError, UpstreamConfiguration, UpstreamInitCallback,
